...
Mỗi tag `v*` tạo một APK độc lập (release variant, ký bằng khóa phát triển) và đăng lên GitHub Releases bằng GitHub Actions. Để tạo APK mới, đẩy tag phiên bản, ví dụ `v1.1.2`.
